...
num2 = 50; // the change won't affect num1 // ja assignirame vrednosta
...
// ===> Example: List<int>
List<int> ints1 = new List<int> { 1, 2, 3 }; // heap a ints1 v =o stackot ama pokazuva kon stackot
List<int> ints2 = ints1; // passing reference to the ints1 list  // davame referenca 
...
// Iako stringovite se referentni tipovi, vo mnogu nesta se slicni so value types
// instancite se cuvaat vo stackot
...
// Konstruktor i Destruktor (c++) // Class Finalier destruktor
